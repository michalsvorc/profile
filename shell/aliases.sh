...
alias uig='nvim -c "lua require(\"neogit\").open()"'
alias fe='nvim -c "lua require(\"telescope\").extensions.file_browser.file_browser({ path = vim.fn.expand(\"%:p:h\"), select_buffer = true })"'
